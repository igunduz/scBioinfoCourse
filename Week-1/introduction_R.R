...
devtools::install_github("compgenomr/compGenomRData") #install package from github
...
enh <- read.table(enhancerFilePath, header = FALSE) 

# read CpG island BED file
cpgi <- read.table(cpgiFilePath, header = FALSE) 
